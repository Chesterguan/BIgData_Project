...
if __name__ == '__main__':
    ...
    writer=csv.writer(open('/home/chesterguan/bigdataprojects/deepspeech.pytorch-master/data/After_transcribelist.csv','w'))
    file_path='/home/chesterguan/bigdataprojects/deepspeech.pytorch-master/data/Project-files6/'
